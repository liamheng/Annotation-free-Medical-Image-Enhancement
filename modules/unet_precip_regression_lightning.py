...
# import torchmetrics as pl
# from modules.regression_lightning import Precip_regression_base


class UNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=3, bilinear=1):
...
#                         default='../images/precipitation/RAD_NL25_RAC_5min_train_test_2016-2019.h5', type=str)
