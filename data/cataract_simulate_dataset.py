...
class CataractSimulateDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # source_mask_path = os.path.join(self.dir_source_mask, original_image_name)
        ...
        SU = Image.open(source_segmentation_path).convert('RGB')
        w, h = SAB.size
        w2 = int(w / 2)
