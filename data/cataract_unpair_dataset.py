...
class CataractUnpairDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_sourceA = os.path.join(opt.dataroot, 'source')  # get the images directory
        self.dir_sourceB = os.path.join(opt.dataroot, 'source')  # get the images directory
    ...
    def __getitem__(self, index):
        ...
        SA = Image.open(sourceA_path).convert('RGB')
        SB = Image.open(sourceB_path).convert('RGB')
