...
import random
import torch
from data.base_dataset import BaseDataset, get_params, get_transform_RGB_mask_gray
from data.image_folder import make_dataset
from PIL import Image


class CataractGrayPaddingDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        source_A_transform, source_A_mask_transform, source_A_gray_transform = get_transform_RGB_mask_gray(self.opt, source_transform_params)
        source_B_transform, source_B_mask_transform, source_B_gray_transform = get_transform_RGB_mask_gray(self.opt, source_transform_params)
