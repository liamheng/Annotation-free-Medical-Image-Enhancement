...
class BaseDataset(data.Dataset, ABC):
    ...
    -- <__getitem__>:                   get a images point.
    ...
    def __getitem__(self, index):
        ...
        Returns:
            a dictionary of images with their names. It ususally contains the images itself and its metadata information.
        """
        pass
        ...
        if opt.source_size_count == 1:
            ...
            if not opt.isTrain:
                ...
                if opt.load_size == 512:
                    ...
                    # new_h = new_w = random.choice([286, 306, 326, 346, 562, 808])
...
def get_transform_RGB_mask_gray(opt, params=None, method=Image.BICUBIC, convert=True):
    transform_list = []
    gray_transform_list = []
    mask_transform_list = []
    # if grayscale:
...
def get_transform_four_channel(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True):
    transform_list = []
...
def __print_size_warning(ow, oh, w, h):
    """Print warning information about images size(only print once)"""
