...
class ColorizationDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        By default, the number of channels for input images  is 1 (L) and
        the number of channels for output images is 2 (ab). The direction is from A to B
        """
    ...
    def __getitem__(self, index):
        ...
        Returns a dictionary that contains A, B, A_paths and B_paths
            A (tensor) - - the L channel of an images
            B (tensor) - - the ab channels of the same images
