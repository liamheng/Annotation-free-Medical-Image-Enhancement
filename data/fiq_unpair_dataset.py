...
class FiqUnpairDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        gt_path = self.image_paths[random.randint(0, len(self.image_paths)-1)].split('-')[0].replace('.png', '').replace('source_image', 'source_gt') + '.png'
