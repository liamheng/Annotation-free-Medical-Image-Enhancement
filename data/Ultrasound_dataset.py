...
class UltrasoundDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        # self.dir_source_noise = os.path.join(opt.dataroot, 'test_two')  # get the images directory
        # self.dir_source_gt = os.path.join(opt.dataroot, 'test_two')  # get the images directory
        #
        # self.dir_source_noise = os.path.join(opt.dataroot, 'test_three')  # get the images directory
        # self.dir_source_gt = os.path.join(opt.dataroot, 'test_three')  # get the images directory
        # else:
    ...
    def __getitem__(self, index):
        ...
        return {'source_noise': source_noise, 'source_gt': source_gt, "SA_path": image_path,"segmentation_mask":source_gt}
