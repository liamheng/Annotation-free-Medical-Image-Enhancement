...
#       python batch_hed.py --images_dir=/images/to/path/photos/ --hed_mat_dir=/images/to/path/hed_mat_files/
...
for i in range(nImgs):
    if i % 500 == 0:
        print('processing images %d/%d' % (i, nImgs))
    ...
    # shape for input (images blob is N x C x H x W), set images
    net.blobs['images'].reshape(1, *in_.shape)
    net.blobs['images'].data[...] = in_
