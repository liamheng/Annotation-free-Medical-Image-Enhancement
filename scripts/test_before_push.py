...
if __name__ == '__main__':
    ...
    if not os.path.exists('./checkpoints/horse2zebra_pretrained/latest_net_S.pth'):
        run('bash ./scripts/download_cyclegan_model.sh horse2zebra')
    run('python test_total.py --model test_total --dataroot ./datasets/mini --name horse2zebra_pretrained --no_dropout --num_test 1 --no_dropout')

    # pretrained pix2pix model
    if not os.path.exists('./checkpoints/facades_label2photo_pretrained/latest_net_S.pth'):
    ...
    run('python test_total.py --dataroot ./datasets/facades/ --direction BtoA --model pix2pix --name facades_label2photo_pretrained --num_test 1')

    # cyclegan train/test_total
    ...
    run('python test_total.py --model test_total --name temp_cyclegan --dataroot ./datasets/mini --num_test 1 --model_suffix "_A" --no_dropout')

    # pix2pix train/test_total
    ...
    run('python test_total.py --model pix2pix --name temp_pix2pix --dataroot ./datasets/mini_pix2pix --num_test 1')

    # template train/test_total
    ...
    run('python test_total.py --model template --name temp2 --dataroot ./datasets/mini_pix2pix --num_test 1')

    # colorization train/test_total (optional)
    ...
    run('python test_total.py --model colorization --name temp_color --dataroot ./datasets/mini_colorization --num_test 1')
