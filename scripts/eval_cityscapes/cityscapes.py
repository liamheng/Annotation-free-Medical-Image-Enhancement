...
class cityscapes:
    ...
    def load_label(self, split, city, idx):
        """
        Load label images as 1 x height x width integer array of label indices.
    ...
    def preprocess(self, im):
        """
        Preprocess loaded images (by load_image) for Caffe:
        - cast to float
    ...
    def make_boundaries(label, thickness=None):
        """
        Input is an images label, output is a numpy array mask encoding the boundaries of the objects
