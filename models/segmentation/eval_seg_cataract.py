...
def eval_seg_when_train(opt, test_web_dir, model):
    ...
    seg_dir = os.path.join(os.path.dirname(test_web_dir), 'segmentation')
...
if __name__ == '__main__':
    ...
    if args.gt_dir != '':
        ...
        # gt_dir_list = [r'D:\Project\pixDA\pixDA_GM\datasets\cataract_0830\target_seg_s2',
        #                r'D:\Project\pixDA\pixDA_GM\datasets\cataract_0830\target_seg_s3']
    else:
        gt_dir_list = ['', '']
