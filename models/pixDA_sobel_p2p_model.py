...
class PixDASobelP2pModel(BaseModel):
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_L1G', type=float, default=200.0, help='weight for L1G loss')
    ...
    def backward_G(self):
        ...
        self.loss_G_DPG = self.criterionGAN(pred_fake_SABG, True)
        ...
        self.loss_G = self.loss_G_DP + self.loss_G_DPG + self.loss_G_L1 + self.loss_G_L1G + self.loss_G_DD
