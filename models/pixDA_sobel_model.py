...
class PixDASobelModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='unet_256', dataset_mode='aligned', input_nc=6)
        if is_train:
            parser.set_defaults(pool_size=0, gan_mode='vanilla')
            parser.add_argument('--lambda_L1', type=float, default=100.0, help='weight for L1 loss')
            parser.add_argument('--lambda_DD', type=float, default=0.1, help='weight for DD')
            parser.add_argument('--lambda_DP', type=float, default=0.1, help='weight for DP')
            parser.add_argument('--lambda_DPG', type=float, default=0.1, help='weight for DPG')
    ...
    def __init__(self, opt):
        ...
        self.visual_names_train = ['real_SA', 'real_SAG', 'fake_SB', 'fake_SBG', 'real_SB', 'real_SBG', 'real_TA', 'real_TAG',
                             'fake_TB', 'fake_TBG']
