...
class PixDGOSUnetDisModel(BaseModel):
    ...
    def backward_D(self):
        ...
        self.D_pred_fake = self.netD(self.fake_SB.detach())
        # D希望假就是假，真就是真
        self.loss_D_fake = self.criterionGAN(self.D_pred_fake, False)
        # Real
        # pred_real是对真实图像对的预测分数
        self.D_pred_real = self.netD(self.real_SB.detach())
        # D希望假就是假，真就是真
    ...
    def backward_G(self):
        ...
        self.G_pred_fake = self.netD(self.fake_SB)
