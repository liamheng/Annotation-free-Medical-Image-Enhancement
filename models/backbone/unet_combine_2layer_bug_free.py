...
class UnetCombine2LayerGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, get_feature=False):
    ...
    def forward(self, x):
        ...
        # return u1
        if self.get_feature:
            return h_u1, u1, [d1, d2, d3, d4, d5, d6, d7, d8]
            # return h_u1, u1, [h_u1, h_u2, h_u3, h_u4, u1, u2, u3, u4]
        return h_u1, u1
