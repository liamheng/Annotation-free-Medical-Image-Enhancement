...
class PixDAG2DDPDP3Model(BaseModel):
    @staticmethod
    ...
    def set_input(self, input, isTrain=None):
        ...
        self.real_SAG = self.edge_filter(self.real_SA, self.S_mask)
        self.real_TAG = self.edge_filter(self.real_TA, self.T_mask)
        self.real_SBG = self.edge_filter(self.real_SB, self.S_mask)
    ...
    def forward(self):
        ...
        self.fake_SBG = self.edge_filter(self.fake_SB, self.S_mask)
        self.fake_TBG = self.edge_filter(self.fake_TB, self.T_mask)
