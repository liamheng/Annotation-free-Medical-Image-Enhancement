...
class CycleGANDAModel(BaseModel):
    """
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_DD', type=float, default=1.0, help='weight for DD')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'G_DD', 'DD']
        ...
        if self.isTrain:
            self.model_names = ['G_A', 'G_B', 'D_A', 'D_B', 'DD']
    ...
    def backward_DD(self):
        self.loss_DD = self.backward_D_basic(self.netDD, self.fake_B, self.fake_TB)
    ...
    def optimize_parameters(self):
        ...
        # G_A and G_B
        self.set_requires_grad([self.netD_A, self.netD_B, self.netDD], False)  # Ds require no gradients when optimizing Gs
        self.optimizer_G.zero_grad()  # set G_A and G_B's gradients to zero
        self.backward_G()             # calculate gradients for G_A and G_B
        self.optimizer_G.step()       # update G_A and G_B's weights
        # D_A and D_B
        self.set_requires_grad([self.netD_A, self.netD_B, self.netDD], True)
