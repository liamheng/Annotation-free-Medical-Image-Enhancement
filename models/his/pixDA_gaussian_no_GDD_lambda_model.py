...
from models.guided_filter_pytorch.gaussian_filter import OneGaussianFilter, OneGaussianLambdaFilter
from data.base_dataset import TensorToGrayTensor

class PixDAGaussianNoGDDLambdaModel(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        assert opt.edge_filter == 'one_gaussian_filter_lambda'
        self.edge_filter = OneGaussianLambdaFilter(self.device, opt.filter_width, size=opt.crop_size, lambda_=1)
    ...
    def backward_G(self):
        ...
        self.loss_G = self.loss_G_DP + self.loss_G_DD + self.loss_G_L1G
