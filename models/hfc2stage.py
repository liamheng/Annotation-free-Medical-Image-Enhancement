...
class HFC2StageModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'real_AH', 'fake_BH', 'fake_B', 'real_B', 'real_BH']
    ...
    def set_input(self, input, isTrain=None):
        ...
        self.real_AH = self.hfc_filter(self.real_A)
        self.real_BH = self.hfc_filter(self.real_B)
    ...
    def forward(self):
        ...
        self.fake_B = self.netGL(self.fake_BH)  # G(A)
    ...
    def backward_GH(self):
        self.loss_G_L1H = self.criterionL1(self.fake_BH.detach(), self.real_BH) * self.opt.lambda_L1H
