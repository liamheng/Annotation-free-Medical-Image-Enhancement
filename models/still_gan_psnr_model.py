...
class StillGANPSNRModel(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B','psnr_A','psnr_B']
        ...
        if self.isTrain:
            ...
            self.criterionPSNR = torch.nn.L1Loss()
    ...
    def backward_G(self):
        ...
        if lambda_Structure > 0:
            ...
            self.loss_psnr_A = self.criterionPSNR(self.fake_A, self.real_A) * lambda_A * lambda_Structure
            self.loss_psnr_B = self.criterionPSNR(self.fake_B, self.real_B) * lambda_B * lambda_Structure
            # TODO
        ...
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A \
                      ...
                      - self.loss_psnr_A - self.loss_psnr_B
