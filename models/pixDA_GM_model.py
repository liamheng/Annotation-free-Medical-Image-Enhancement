...
class PixDAGMModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_SA', 'real_SA_G', 'fake_SB', 'fake_SB_G',
                             'real_SB', 'real_SB_G',
                             'real_TA', 'real_TA_G',
                             'fake_TB', 'fake_TB_G']
        if self.isTrain:
    ...
    def forward(self):
        ...
        self.fake_SB, self.real_SA_G, self.fake_SB_G = self.netG(self.real_SA, self.S_mask)  # G(SA)
        self.fake_TB, self.real_TA_G, self.fake_TB_G = self.netG(self.real_TA, self.T_mask)  # G(TA)
