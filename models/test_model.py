...
class TestModel(BaseModel):
    ...
    See the test_total instruction for more details.
    """
    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        ...
        The model can only be used during test_total time. It requires '--dataset_mode single'.
    ...
    def optimize_parameters(self):
        """No optimization for test_total model."""
        pass
