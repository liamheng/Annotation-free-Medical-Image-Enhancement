...
class HFC2StageV2Model(BaseModel):
    ...
    def backward_GL(self):
        self.loss_G_S2_L1 = self.criterionL1(self.fake_S2_S, self.real_SB) * self.opt.lambda_S2_L1
        self.loss_G_S2_L1H = self.criterionL1(self.fake_S2_SH, self.real_SBH) * self.opt.lambda_S2_L1H
