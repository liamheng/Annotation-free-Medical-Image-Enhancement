...
class pixDGIdtLowModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_L1H', 'G_L1H_idt', 'G_DPH', 'GH', 'DH',
                           'G_L1F', 'G_L1FH', 'G_DPF', 'GF', 'DF']

        self.visual_names_train = ['real_SA', 'real_SAH', 'real_SAL', 'fake_SH', 'fake_SH_idt',
    ...
    def backward_GH(self):
        ...
        self.loss_GH = self.loss_G_DPH + self.loss_G_L1H + self.loss_G_L1H_idt
